...
try:
    ...
    # Fallback for testing without langchain dependencies
    class ChatLiteLLM:
        ...
        async def apredict_messages(self, messages: List[Dict]) -> Any:
            class MockResponse:
...
class LLMFactory:
    ...
    def create_orchestrator_llm() -> ChatLiteLLM:
        ...
        if not api_base:
            raise LLMValidationError("LITELLM_BASE_URL environment variable is required")
