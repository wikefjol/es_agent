...
def mock_elasticsearch_client():
    ...
    # Mock common methods
    client.info = Mock(
        return_value={"version": {"number": "7.13.0"}, "cluster_name": "test-cluster"}
    )

    # Mock cluster object and its methods
    client.cluster = Mock()
    client.cluster.health = Mock(return_value={"status": "green", "number_of_nodes": 3})
...
def sample_es_publication_hit():
    ...
    return {
        ...
        "_source": {
            ...
            "Source": {
                "SourceSerial": {"Title": "Journal of Machine Learning Research"},
                "Volume": "24",
                "Issue": "3",
                "Pages": "123-145",
            },
...
def es_error_responses():
    ...
    return {
        ...
        "timeout_error": ConnectionTimeout(
            "Request timed out", ("127.0.0.1", 9200), "Request timed out"
        ),
